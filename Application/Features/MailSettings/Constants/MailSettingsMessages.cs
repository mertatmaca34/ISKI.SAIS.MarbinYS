namespace Application.Features.MailSettings.Constants;

public static class MailSettingsMessages
{
    public const string Listed = "Mail ayarları başarıyla listelendi.";
