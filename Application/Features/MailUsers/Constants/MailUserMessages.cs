namespace Application.Features.MailUsers.Constants;

public static class MailUserMessages
{
    public const string Listed = "Mail kullanıcıları başarıyla listelendi.";
