...
{
    public const string ApiUrl = "api/stations";
    public const string InvalidStationIdMessage = "Geçersiz istasyon Id";
    public const string InvalidDataPeriodMessage = "Geçersiz veri periyodu";
    public const string InvalidDateMessage = "Geçersiz tarih";
