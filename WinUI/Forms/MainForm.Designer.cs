namespace WinUI.Forms
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            SideBarTableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 12F));
            SideBarTableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 12F));
            SideBarTableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 12F));
            SideBarTableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 12F));
            SideBarTableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 12F));
            SideBarTableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 12F));
            SideBarTableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 16F));
            SideBarTableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 12F));
            SideBarTableLayoutPanel.Size = new Size(120, 681);
            ...
            HomePageButton.Font = new Font("Segoe UI", 9F);
            ...
            HomePageButton.Margin = new Padding(12, 12, 12, 12);
            HomePageButton.Name = "HomePageButton";
            HomePageButton.Size = new Size(96, 57);
            ...
            SimulationPageButton.Font = new Font("Segoe UI", 9F);
            SimulationPageButton.ForeColor = Color.DimGray;
            SimulationPageButton.Image = Properties.Resources.monitor_24px;
            SimulationPageButton.Dock = DockStyle.Fill;
            SimulationPageButton.Margin = new Padding(12);
            SimulationPageButton.Name = "SimulationPageButton";
            SimulationPageButton.Size = new Size(96, 57);
            ...
            CalibrationPageButton.Font = new Font("Segoe UI", 9F);
            ...
            CalibrationPageButton.Dock = DockStyle.Fill;
            CalibrationPageButton.Margin = new Padding(12);
            CalibrationPageButton.Name = "CalibrationPageButton";
            CalibrationPageButton.Size = new Size(96, 57);
            ...
            ReportingPageButton.Font = new Font("Segoe UI", 9F);
            ReportingPageButton.ForeColor = Color.DimGray;
            ReportingPageButton.Image = Properties.Resources.save_24px;
            ReportingPageButton.Dock = DockStyle.Fill;
            ReportingPageButton.Margin = new Padding(12);
            ReportingPageButton.Name = "ReportingPageButton";
            ReportingPageButton.Size = new Size(96, 57);
            ...
            MailPageButton.Font = new Font("Segoe UI", 9F);
            MailPageButton.ForeColor = Color.DimGray;
            MailPageButton.Image = Properties.Resources.alarm_24px;
            MailPageButton.Dock = DockStyle.Fill;
            MailPageButton.Margin = new Padding(12);
            MailPageButton.Name = "MailPageButton";
            MailPageButton.Size = new Size(96, 57);
            ...
            SettingsPageButton.Font = new Font("Segoe UI", 9F);
            SettingsPageButton.ForeColor = Color.DimGray;
            SettingsPageButton.Image = Properties.Resources.settings_24px;
            SettingsPageButton.Dock = DockStyle.Fill;
            SettingsPageButton.Margin = new Padding(12);
            SettingsPageButton.Name = "SettingsPageButton";
            SettingsPageButton.Size = new Size(96, 57);
            ...
            LoginButton.Margin = new Padding(12);
            LoginButton.Name = "LoginButton";
            LoginButton.Size = new Size(96, 57);
            ...
            MainContentPanel.Location = new Point(120, 0);
            MainContentPanel.Name = "MainContentPanel";
            MainContentPanel.Size = new Size(1144, 681);
